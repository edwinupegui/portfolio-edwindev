...
function ViewPage() {
  ...
  return (
    <motion.div
      ...
      className="hidden w-full max-xl:hidden lg:block lg:w-fit"
    >
      <div className="sticky top-5 h-fit w-full rounded-2xl md:w-60">
        <div className="flex flex-col gap-y-3">
          <div className="min-w-min rounded-2xl border border-neutral-800 bg-[#1c1c1c] p-4 text-neutral-200">
            ...
            <div className="text-neutral-400">
              ...
              <div className="mt-6 flex items-center gap-x-3 rounded-md p-2 hover:bg-neutral-800">
